...
def send_mail_method(user=None, domain=None, subject=None, email=None):
    message = render_to_string('default/acc_active_email.html', {
        'user': user,
        'domain': domain,
...
class SignUpViewMain(TemplateView):
    template_name = 'default/signup_main.html'
...
class ResetPasswordRequestView(FormView):
    template_name = "default/reset-password.html"
    success_url = '/'
...
class PasswordResetConfirmView(FormView):
    template_name = "default/password_reset_confirm.html"
    success_url = '/'
